...
class Perm_EweiShopV2ComModel extends ComModel
{
	...
	'distribution'    => array('text' => '配送员', 'main' => '查看列表', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
