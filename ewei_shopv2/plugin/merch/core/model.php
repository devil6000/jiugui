...
class MerchModel extends PluginModel
{
	...
	public function allPerms()
	{
		if (empty(self::$allPerms)) {
            ...
            $perms = array('shop' => $this->perm_shop(), 'order' => $this->perm_order(), 'perm' => $this->perm_perm(), 'apply' => $this->perm_apply(), 'exhelper' => $this->perm_exhelper(), 'diypage' => $this->perm_diypage(), 'quick' => $this->perm_quick());
            self::$allPerms = $perms;
		}
